...
table = (
    ...
    , ( 'CMakeLists.txt'
        , r'set\W+type_version\W+"([0-9]+\.[0-9]+\.[0-9]+)"\W+$'
        , 'set( type_version "{major}.{minor}.{patch}" )\n' )

#    , ( 'example/cmake-pkg/CMakeLists.txt'
#        , r'set\W+type_version\W+"([0-9]+\.[0-9]+(\.[0-9]+)?)"\W+$'
#        , 'set( type_version "{major}.{minor}" )\n' )
#
...
#        , 'type_version = "{major}.{minor}.{patch}"\n' )
    ...
    , ( 'include/nonstd/type.hpp'
        ...
        , '#define type_MAJOR  {major}' )

    , ( 'include/nonstd/type.hpp'
        , r'\#define\s+type_MINOR\s+[0-9]+\s*$'
        , '#define type_MINOR  {minor}' )

    , ( 'include/nonstd/type.hpp'
        , r'\#define\s+type_PATCH\s+[0-9]+\s*$'
        , '#define type_PATCH  {patch}\n' )
)
